...
const ResultPage = () => {
  ...
  const getOriginPath = () => {
    ...
    if (state.examType === 'examen-temas') return '/examen-por-temas';
  ...
  return (
    <div className="results">
      ...
      <div className="result-details">
        <p>Preguntas correctas: <strong>{correct}</strong></p>
        <p>Preguntas incorrectas: <strong>{incorrect}</strong></p>
        {unanswered > 0 && (
          <p>Preguntas sin contestar: <strong>{unanswered}</strong></p>
        )}
      ...
      <div className='respuestas_desarrolladas'>
        ...
        {state.questions.map((question, index) => {
          ...
          return (
            <div key={index} className={`pregunta_completa ${hasAnswer ? (isCorrect ? 'correct-question' : 'incorrect-question') : ''}`}>
